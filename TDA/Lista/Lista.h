...
booleano eliminarDeListaEnPos(Lista* pl, const void* elem, size_t tamElem,int pos);
booleano eliminarDeListaFrente(Lista* pl, const void* elem, size_t tamElem);
booleano eliminarDeListaFondo(Lista* pl, const void* elem, size_t tamElem);
